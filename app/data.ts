...
export const celestialBodies: CelestialBody[] = [
  ...
  { id: "neutron-star", name: "Estrela de nêutrons", kind: "estrela-neutrons", massKg: 2.7846e30, radiusM: 1.2e4, color: "#9ed7ff", atmosphere: false, evidence: "observed", description: "Remanescente estelar observado: cerca de 1,4 massa solar comprimida em um raio didático de 12 km, compatível com medições da missão NICER/NASA." },
  { id: "planck-star", name: "Estrela de Planck", kind: "estrela-planck", massKg: 1.989e30, radiusM: 1e-15, color: "#d18cff", atmosphere: false, evidence: "hypothesis", description: "Hipótese de gravidade quântica em loop para um estado ultracompacto no interior de um buraco negro. Não foi observada; massa e escala do cenário são apenas parâmetros didáticos." },
